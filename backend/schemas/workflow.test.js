...
describe('WorkflowSchema', () => {
  const validWorkflow = {
    ...
    nodes: [
      { id: '1', type: 'trigger', label: 'Start', detail: 'Entry point triggered by the user.', position: { x: 0, y: 0 } },
      { id: '2', type: 'agent', label: 'Research Agent', detail: 'Performs research using web search tools.', position: { x: 0, y: 120 } },
    ],
    edges: [
  ...
  test('rejects node missing detail', () => {
    const bad = {
      ...validWorkflow,
